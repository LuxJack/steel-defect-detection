  ...
  <div class="auth-container">
    ...
    <div class="auth-card glass-effect fade-in">
      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <div class="form-group">
          <div class="input-wrapper">
            ...
            <div class="input-content">
              <label for="email" class="input-label">EMAIL / 邮箱</label>
              <input
                id="email"
                v-model="form.email"
                type="email"
        ...
        <div class="form-group">
          <div class="input-wrapper">
            ...
            <div class="input-content">
              <label for="confirmPassword" class="input-label">CONFIRM PASSWORD / 确认密码</label>
              <input
                id="confirmPassword"
      ...
      <div class="auth-footer">
        <router-link to="/login" class="auth-link">返回账号登录</router-link>
      </div>
    </div>
  </div>
</template>
